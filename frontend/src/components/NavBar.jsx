...
const NavBar = () => {
    ...
    // 1. Pull the new variables we added to ShopContext
    ...
    return (
        <div className='flex items-center justify-between py-5 font-medium'>
            ...
            {/* FIX 1: Added missing </Link> tag here */}
            <Link to='/'>
                <img src={assets.logo} className='w-36' alt="Soko Mkononi" />
            </Link>
                    ...
                    {token && 
                        <div className='absolute right-0 hidden pt-4 group-hover:block dropdown-menu'>
                            <div className='flex flex-col gap-2 px-5 py-3 text-gray-500 rounded w-36 bg-slate-100'>
                                ...
                                <p onClick={() => navigate('/orders')} className='cursor-pointer hover:text-black'>My Deliveries</p>
            ...
            {/* FIX 2: Changed 'KSh{' to '${' for the dynamic width */}
